...
public class CRFTagger implements Tagger
{
    ...
    /**
     * Loads a {@link sample.extractor.CRFTagger} from the specified file. As the lemmatiser and part-of-speech tagger both require data, these cannot be written to
    ...
    /**
     * Trains and returns a {@link sample.extractor.CRFTagger} on the specified {@link Sentence}s. This method may take hours or even days to complete. When training,
    ...
    /**
     * @return Whether this {@link sample.extractor.CRFTagger} was trained with feature induction
     */
    ...
    /**
     * @return The {@link TextDirection} used by this {@link sample.extractor.CRFTagger}
     */
